...
namespace Microsoft.Azure.Management.ServiceBus.Models
{
    ...
    public partial class NetworkRuleSetListResult
    {
        ...
        /// Initializes a new instance of the NetworkRuleSetListResult class.
        /// </summary>
        /// <param name="value">Result of the List NetworkRuleSet
        /// operation.</param>
        /// <param name="nextLink">Link to the next set of results. Not empty
        /// if Value contains incomplete list of NetworkRuleSet.</param>
        public NetworkRuleSetListResult(IList<NetworkRuleSet> value = default(IList<NetworkRuleSet>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        public IList<NetworkRuleSet> Value { get; set; }
