...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class IotSitesOperationsExtensions
    {
            ...
            /// </param>
            public static IotSitesModel CreateOrUpdate(this IIotSitesOperations operations, string scope, string displayName, IDictionary<string, string> tags)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotSitesModel> CreateOrUpdateAsync(this IIotSitesOperations operations, string scope, string displayName, IDictionary<string, string> tags, CancellationToken cancellationToken = default(CancellationToken))
            {
