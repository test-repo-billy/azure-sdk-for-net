...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class SubAssessmentsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<SecuritySubAssessment> List1(this ISubAssessmentsOperations operations, string scope, string assessmentName)
            {
                return operations.List1Async(scope, assessmentName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<SecuritySubAssessment>> List1Async(this ISubAssessmentsOperations operations, string scope, string assessmentName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.List1WithHttpMessagesAsync(scope, assessmentName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<SecuritySubAssessment> List1Next(this ISubAssessmentsOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<SecuritySubAssessment>> List1NextAsync(this ISubAssessmentsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
