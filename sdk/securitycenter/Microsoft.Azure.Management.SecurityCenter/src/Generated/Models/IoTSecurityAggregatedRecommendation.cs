...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class IoTSecurityAggregatedRecommendation
    {
        ...
        /// GUID.</param>
        /// <param name="detectedBy">Name of the vendor that discovered the
        /// issue</param>
        /// <param name="remediationSteps">Recommended steps for
        /// remediation</param>
        /// <param name="reportedSeverity">Estimated severity of this
        /// recommendation. Possible values include: 'Informational', 'Low',
        /// 'Medium', 'High'</param>
        /// <param name="healthyDevices">the number of the healthy devices
        /// within the solution</param>
        /// <param name="unhealthyDeviceCount">the number of the unhealthy
        /// devices within the solution</param>
        ...
        /// <summary>
        /// Gets estimated severity of this recommendation. Possible values
        ...
        /// <summary>
        /// Gets the number of the healthy devices within the solution
        /// </summary>
        [JsonProperty(PropertyName = "properties.healthyDevices")]
        public int? HealthyDevices { get; private set; }

        /// <summary>
        /// Gets the number of the unhealthy devices within the solution
        /// </summary>
