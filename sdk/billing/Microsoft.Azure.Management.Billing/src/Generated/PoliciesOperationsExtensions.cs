...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class PoliciesOperationsExtensions
    {
            ...
            /// <summary>
            /// The policy for a given billing account name and billing profile name and
            /// customer name.
            /// <see href="https://docs.microsoft.com/en-us/rest/api/billing/" />
            /// </summary>
            /// <param name='operations'>
            ...
            /// Customer name.
            /// </param>
            public static CustomerPolicy GetByCustomer(this IPoliciesOperations operations, string billingAccountName, string billingProfileName, string customerName)
            {
                return operations.GetByCustomerAsync(billingAccountName, billingProfileName, customerName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CustomerPolicy> GetByCustomerAsync(this IPoliciesOperations operations, string billingAccountName, string billingProfileName, string customerName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetByCustomerWithHttpMessagesAsync(billingAccountName, billingProfileName, customerName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static CustomerPolicy UpdateCustomer(this IPoliciesOperations operations, string billingAccountName, string billingProfileName, string customerName, CustomerPolicy parameters)
            {
                return operations.UpdateCustomerAsync(billingAccountName, billingProfileName, customerName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<CustomerPolicy> UpdateCustomerAsync(this IPoliciesOperations operations, string billingAccountName, string billingProfileName, string customerName, CustomerPolicy parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateCustomerWithHttpMessagesAsync(billingAccountName, billingProfileName, customerName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
