...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// <summary>
    /// Defines headers for DownloadByBillingProfileName operation.
    /// </summary>
    public partial class PriceSheetDownloadByBillingProfileNameHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PriceSheetDownloadByBillingProfileNameHeaders class.
        /// </summary>
        public PriceSheetDownloadByBillingProfileNameHeaders()
        {
            CustomInit();
        }
        ...
        public PriceSheetDownloadByBillingProfileNameHeaders(string location = default(string), string retryAfter = default(string), string oDataEntityId = default(string))
        {
            Location = location;
