...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class PriceSheetOperationsExtensions
    {
            ...
            /// Billing Profile Id.
            /// </param>
            public static DownloadUrl DownloadByBillingProfileName(this IPriceSheetOperations operations, string billingAccountName, string billingProfileName)
            {
                return operations.DownloadByBillingProfileNameAsync(billingAccountName, billingProfileName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DownloadUrl> DownloadByBillingProfileNameAsync(this IPriceSheetOperations operations, string billingAccountName, string billingProfileName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DownloadByBillingProfileNameWithHttpMessagesAsync(billingAccountName, billingProfileName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Billing Profile Id.
            /// </param>
            public static DownloadUrl BeginDownloadByBillingProfileName(this IPriceSheetOperations operations, string billingAccountName, string billingProfileName)
            {
                return operations.BeginDownloadByBillingProfileNameAsync(billingAccountName, billingProfileName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<DownloadUrl> BeginDownloadByBillingProfileNameAsync(this IPriceSheetOperations operations, string billingAccountName, string billingProfileName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.BeginDownloadByBillingProfileNameWithHttpMessagesAsync(billingAccountName, billingProfileName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
