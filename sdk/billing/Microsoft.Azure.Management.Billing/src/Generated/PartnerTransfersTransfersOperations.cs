...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class PartnerTransfersTransfersOperations : IServiceOperations<BillingManagementClient>, IPartnerTransfersTransfersOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<TransferDetails>>> ListWithHttpMessagesAsync(string billingAccountName, string customerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountName}/customers/{customerName}/transfers").ToString();
