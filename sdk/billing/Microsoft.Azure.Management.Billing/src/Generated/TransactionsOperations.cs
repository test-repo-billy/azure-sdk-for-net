...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class TransactionsOperations : IServiceOperations<BillingManagementClient>, ITransactionsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<Transaction>>> ListByBillingAccountNameNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
