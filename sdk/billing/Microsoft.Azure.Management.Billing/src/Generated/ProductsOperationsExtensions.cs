...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class ProductsOperationsExtensions
    {
            ...
            /// </param>
            public static UpdateAutoRenewOperation UpdateAutoRenewByBillingAccount(this IProductsOperations operations, string billingAccountName, string productName, UpdateAutoRenewRequest body)
            {
                return operations.UpdateAutoRenewByBillingAccountAsync(billingAccountName, productName, body).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<UpdateAutoRenewOperation> UpdateAutoRenewByBillingAccountAsync(this IProductsOperations operations, string billingAccountName, string productName, UpdateAutoRenewRequest body, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateAutoRenewByBillingAccountWithHttpMessagesAsync(billingAccountName, productName, body, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
