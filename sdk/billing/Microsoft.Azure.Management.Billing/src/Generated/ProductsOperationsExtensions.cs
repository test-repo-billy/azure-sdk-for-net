...
namespace Microsoft.Azure.Management.Billing
{
    ...
    public static partial class ProductsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<Product> ListByBillingAccountName(this IProductsOperations operations, string billingAccountName, string filter = default(string))
            {
            ...
            /// </param>
            public static async Task<IPage<Product>> ListByBillingAccountNameAsync(this IProductsOperations operations, string billingAccountName, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// separated by a colon (:).
            /// </param>
            public static ProductsListResult ListByInvoiceSectionName(this IProductsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, string filter = default(string))
            {
                return operations.ListByInvoiceSectionNameAsync(billingAccountName, billingProfileName, invoiceSectionName, filter).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ProductsListResult> ListByInvoiceSectionNameAsync(this IProductsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListByInvoiceSectionNameWithHttpMessagesAsync(billingAccountName, billingProfileName, invoiceSectionName, filter, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static UpdateAutoRenewOperation UpdateAutoRenewByBillingAccountName(this IProductsOperations operations, string billingAccountName, string productName, UpdateAutoRenewRequest body)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<UpdateAutoRenewOperation> UpdateAutoRenewByBillingAccountNameAsync(this IProductsOperations operations, string billingAccountName, string productName, UpdateAutoRenewRequest body, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Update auto renew request parameters.
            /// </param>
            public static UpdateAutoRenewOperation UpdateAutoRenewByInvoiceSectionName(this IProductsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, string productName, UpdateAutoRenewRequest body)
            {
                return operations.UpdateAutoRenewByInvoiceSectionNameAsync(billingAccountName, billingProfileName, invoiceSectionName, productName, body).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<UpdateAutoRenewOperation> UpdateAutoRenewByInvoiceSectionNameAsync(this IProductsOperations operations, string billingAccountName, string billingProfileName, string invoiceSectionName, string productName, UpdateAutoRenewRequest body, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateAutoRenewByInvoiceSectionNameWithHttpMessagesAsync(billingAccountName, billingProfileName, invoiceSectionName, productName, body, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static IPage<Product> ListByBillingAccountNameNext(this IProductsOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<Product>> ListByBillingAccountNameNextAsync(this IProductsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
