...
namespace Microsoft.Azure.Management.MariaDB
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MariaDBManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MariaDBManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationListResult>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DBforMariaDB/operations").ToString();
