...
namespace Microsoft.Azure.Management.MariaDB
{
    ...
    /// </summary>
    internal partial class LocationBasedPerformanceTierOperations : IServiceOperations<MariaDBManagementClient>, ILocationBasedPerformanceTierOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal LocationBasedPerformanceTierOperations(MariaDBManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<PerformanceTierProperties>>> ListWithHttpMessagesAsync(string locationName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.DBforMariaDB/locations/{locationName}/performanceTiers").ToString();
