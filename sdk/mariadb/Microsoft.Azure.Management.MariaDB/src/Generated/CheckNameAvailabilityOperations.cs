...
namespace Microsoft.Azure.Management.MariaDB
{
    ...
    /// </summary>
    internal partial class CheckNameAvailabilityOperations : IServiceOperations<MariaDBManagementClient>, ICheckNameAvailabilityOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal CheckNameAvailabilityOperations(MariaDBManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<NameAvailability>> ExecuteWithHttpMessagesAsync(NameAvailabilityRequest nameAvailabilityRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.DBforMariaDB/checkNameAvailability").ToString();
