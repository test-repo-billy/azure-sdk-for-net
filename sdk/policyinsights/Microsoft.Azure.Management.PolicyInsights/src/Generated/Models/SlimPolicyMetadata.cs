...
namespace Microsoft.Azure.Management.PolicyInsights.Models
{
    ...
    public partial class SlimPolicyMetadata
    {
        ...
        public SlimPolicyMetadata(string metadataId = default(string), string category = default(string), string title = default(string), string owner = default(string), string description = default(string), string requirements = default(string), string additionalContentUrl = default(string), object metadata = default(object), string id = default(string), string type = default(string), string name = default(string))
        {
