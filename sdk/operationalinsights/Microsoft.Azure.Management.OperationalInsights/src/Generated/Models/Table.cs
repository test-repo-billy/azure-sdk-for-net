...
namespace Microsoft.Azure.Management.OperationalInsights.Models
{
    ...
    public partial class Table
    {
        ...
        /// <param name="retentionInDays">The table data retention in days,
        /// between 30 and 730. Setting this property to null will default to
        /// the workspace retention.</param>
        public Table(string id = default(string), string name = default(string), int? retentionInDays = default(int?))
        {
            Id = id;
            Name = name;
        ...
        /// <summary>
        /// Gets or sets the table data retention in days, between 30 and 730.
