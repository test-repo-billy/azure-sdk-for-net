...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class PipelineRun
    {
        ...
        /// <param name="runDimension">Run dimension emitted by Pipeline
        /// run.</param>
        ...
        public PipelineRun(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string runId = default(string), string runGroupId = default(string), bool? isLatest = default(bool?), string pipelineName = default(string), IDictionary<string, string> parameters = default(IDictionary<string, string>), IDictionary<string, string> runDimension = default(IDictionary<string, string>), PipelineRunInvokedBy invokedBy = default(PipelineRunInvokedBy), System.DateTime? lastUpdated = default(System.DateTime?), System.DateTime? runStart = default(System.DateTime?), System.DateTime? runEnd = default(System.DateTime?), int? durationInMs = default(int?), string status = default(string), string message = default(string))
        {
        ...
        /// <summary>
        /// Gets run dimension emitted by Pipeline run.
        /// </summary>
