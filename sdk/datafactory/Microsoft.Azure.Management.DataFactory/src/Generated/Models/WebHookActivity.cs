...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class WebHookActivity : ControlActivity
    {
        ...
        /// statusCode &gt;= 400 in callback request.</param>
        public WebHookActivity(string name, object url, IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string description = default(string), IList<ActivityDependency> dependsOn = default(IList<ActivityDependency>), IList<UserProperty> userProperties = default(IList<UserProperty>), string timeout = default(string), object headers = default(object), object body = default(object), WebActivityAuthentication authentication = default(WebActivityAuthentication), bool? reportStatusOnCallBack = default(bool?))
        ...
        public bool? ReportStatusOnCallBack { get; set; }
