...
namespace Microsoft.Azure.Management.DataFactory.Models
{
    ...
    public partial class CosmosDbSqlApiSource : CopySource
    {
        ...
        /// <param name="includeSystemColumns">Whether includes system columns
        /// in result. Type: boolean (or Expression with resultType
        /// boolean).</param>
        public CosmosDbSqlApiSource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), object sourceRetryCount = default(object), object sourceRetryWait = default(object), object maxConcurrentConnections = default(object), object query = default(object), object pageSize = default(object), object preferredRegions = default(object), object includeSystemColumns = default(object))
            : base(additionalProperties, sourceRetryCount, sourceRetryWait, maxConcurrentConnections)
        {
            Query = query;
            PageSize = pageSize;
            PreferredRegions = preferredRegions;
            IncludeSystemColumns = includeSystemColumns;
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets whether includes system columns in result. Type:
        /// boolean (or Expression with resultType boolean).
        /// </summary>
        [JsonProperty(PropertyName = "includeSystemColumns")]
        public object IncludeSystemColumns { get; set; }
