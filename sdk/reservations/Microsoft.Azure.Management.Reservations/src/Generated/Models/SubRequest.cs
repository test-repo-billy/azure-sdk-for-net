...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class SubRequest
    {
        ...
        public SubRequest(int? limit = default(int?), string message = default(string), SubRequestName name = default(SubRequestName), string resourceType = default(string), object requestStatus = default(object))
        {
            Limit = limit;
            Message = message;
            Name = name;
