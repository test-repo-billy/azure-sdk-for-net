...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class QuotaRequestDetails : IResource
    {
        ...
        public QuotaRequestDetails(string id = default(string), System.DateTime? requestSubmitTime = default(System.DateTime?), string message = default(string), object requestStatus = default(object), IList<SubRequest> value = default(IList<SubRequest>))
        {
            Id = id;
