...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    internal partial class QuotaRequestOperations : IServiceOperations<MicrosoftCapacityClient>, IQuotaRequestOperations
    {
        ...
        /// </param>
        public async Task<AzureOperationResponse<object>> CreateWithHttpMessagesAsync(string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<object> _response = await BeginCreateWithHttpMessagesAsync(subscriptionId, providerId, location, createQuotaRequest, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// </return>
        public async Task<AzureOperationResponse<object>> BeginCreateWithHttpMessagesAsync(string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
