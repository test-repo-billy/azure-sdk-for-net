...
namespace Microsoft.Azure.Management.IoTSpaces
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<IoTSpacesClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(IoTSpacesClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.IoTSpaces/operations").ToString();
