...
namespace Microsoft.Azure.Management.Storage
{
    ...
    internal partial class FileSharesOperations : IServiceOperations<StorageManagementClient>, IFileSharesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<FileShareItems>> ListWithHttpMessagesAsync(string resourceGroupName, string accountName, string skipToken = default(string), string maxpagesize = default(string), string filter = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<FileShareItems>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<FileShareItems>(_responseContent, Client.DeserializationSettings);
                }
