...
namespace Microsoft.Azure.Management.Logic.Models
{
    ...
    public partial class ApiOperationListResult
    {
        ...
        /// Initializes a new instance of the ApiOperationListResult class.
        /// </summary>
        /// <param name="value">The api operation definitions for an
        /// API.</param>
        /// <param name="nextLink">The URL to get the next set of
        /// results.</param>
        public ApiOperationListResult(IList<ApiOperation> value = default(IList<ApiOperation>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        /// <summary>
        /// Gets or sets the api operation definitions for an API.
        /// </summary>
