...
namespace Microsoft.Azure.Management.Logic
{
    ...
    internal partial class WorkflowRunActionScopeRepetitionsOperations : IServiceOperations<LogicManagementClient>, IWorkflowRunActionScopeRepetitionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<WorkflowRunActionRepetitionDefinition>>> ListWithHttpMessagesAsync(string resourceGroupName, string workflowName, string runName, string actionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<WorkflowRunActionRepetitionDefinition>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<WorkflowRunActionRepetitionDefinition>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<WorkflowRunActionRepetitionDefinition>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
