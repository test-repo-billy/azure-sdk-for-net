...
namespace Microsoft.Azure.Management.Compute.Models
{
    ...
    public partial class AutomaticRepairsPolicy
    {
        ...
        /// false.</param>
        /// <param name="gracePeriod">The amount of time automatic repairs
        /// process waits after a state changing operation completes on virtual
        /// machine scale set. This property allows automatic repairs process
        /// to wait for specified amount of time to allow the application to
        /// start and stabilize in order to avoid premature repairs. The time
        /// duration should be specified in ISO 8601 format. The default value
        /// is 5 minutes (PT5M).</param>
        ...
        /// <summary>
        /// Gets or sets the amount of time automatic repairs process waits
        /// after a state changing operation completes on virtual machine scale
        /// set. This property allows automatic repairs process to wait for
        /// specified amount of time to allow the application to start and
        /// stabilize in order to avoid premature repairs. The time duration
        /// should be specified in ISO 8601 format. The default value is 5
        /// minutes (PT5M).
        /// </summary>
