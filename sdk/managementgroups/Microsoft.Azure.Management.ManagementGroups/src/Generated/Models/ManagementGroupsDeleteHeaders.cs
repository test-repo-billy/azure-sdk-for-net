...
namespace Microsoft.Azure.Management.ManagementGroups.Models
{
    ...
    /// </summary>
    public partial class ManagementGroupsDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ManagementGroupsDeleteHeaders
        /// class.
        /// </summary>
        public ManagementGroupsDeleteHeaders()
        {
            CustomInit();
        }
        ...
        public ManagementGroupsDeleteHeaders(string location = default(string), string azureAsyncOperation = default(string))
        {
            Location = location;
