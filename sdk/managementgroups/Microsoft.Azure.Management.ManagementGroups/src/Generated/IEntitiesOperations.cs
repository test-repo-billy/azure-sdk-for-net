...
namespace Microsoft.Azure.Management.ManagementGroups
{
    ...
    public partial interface IEntitiesOperations
    {
        ...
        /// be able to reparent to as determined by the user's permissions.With
        ...
        /// and  first level of children that the user has either direct access
        /// to or indirect access via one of their descendants.With
        /// $search=ParentOnly the API will return only the group if the user
        /// has access to at least one of the descendants of the group.With
        /// $search=ChildrenOnly the API will return only the first level of
        /// children of the group entity info specified in $filter.  The user
        /// must have direct access to the children entities or one of it's
        /// descendants for it to show up in the results. Possible values
