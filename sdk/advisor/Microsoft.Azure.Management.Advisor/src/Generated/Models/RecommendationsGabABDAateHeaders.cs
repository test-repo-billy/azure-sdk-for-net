...
namespace Microsoft.Azure.Management.Advisor.Models
{
    ...
    /// </summary>
    public partial class RecommendationsGabABDAateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the RecommendationsGabABDAateHeaders
        /// class.
        /// </summary>
        public RecommendationsGabABDAateHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public RecommendationsGabABDAateHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
