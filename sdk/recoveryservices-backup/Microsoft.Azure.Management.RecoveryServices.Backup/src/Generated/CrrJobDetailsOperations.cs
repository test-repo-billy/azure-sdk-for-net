...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class CrrJobDetailsOperations : IServiceOperations<RecoveryServicesBackupClient>, ICrrJobDetailsOperations
    {
        /// <summary>
        /// Initializes a new instance of the CrrJobDetailsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CrrJobDetailsOperations(RecoveryServicesBackupClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<JobResource>> GetWithHttpMessagesAsync(string azureRegion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (azureRegion == null)
            {
