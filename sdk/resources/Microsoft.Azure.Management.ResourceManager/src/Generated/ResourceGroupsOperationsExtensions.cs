...
namespace Microsoft.Azure.Management.ResourceManager
{
    ...
    public static partial class ResourceGroupsOperationsExtensions
    {
            ...
            /// </param>
            /// <param name='forceDeletionResourceTypes'>
            /// The resource types you want to force delete. Currently, only the following
            /// is supported: forceDeletionResourceTypes=Microsoft.Compute/virtualMachines
            /// </param>
            public static void Delete(this IResourceGroupsOperations operations, string resourceGroupName, string forceDeletionResourceTypes = default(string))
            {
                operations.DeleteAsync(resourceGroupName, forceDeletionResourceTypes).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteAsync(this IResourceGroupsOperations operations, string resourceGroupName, string forceDeletionResourceTypes = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteWithHttpMessagesAsync(resourceGroupName, forceDeletionResourceTypes, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// is supported: forceDeletionResourceTypes=Microsoft.Compute/virtualMachines
            /// </param>
            public static void BeginDelete(this IResourceGroupsOperations operations, string resourceGroupName, string forceDeletionResourceTypes = default(string))
            {
                operations.BeginDeleteAsync(resourceGroupName, forceDeletionResourceTypes).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteAsync(this IResourceGroupsOperations operations, string resourceGroupName, string forceDeletionResourceTypes = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeleteWithHttpMessagesAsync(resourceGroupName, forceDeletionResourceTypes, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
