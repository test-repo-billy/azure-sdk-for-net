...
namespace Microsoft.Azure.Management.Attestation.Models
{
    ...
    public partial class JSONWebKey
    {
        ...
        /// type</param>
        /// <param name="d">some d value in JWK</param>
        /// <param name="dp">some dp value in JWK</param>
        /// <param name="dq">some dq value in JWK</param>
        /// <param name="e">some e value in JWK</param>
        /// <param name="k">some k value in JWK</param>
        /// <param name="n">some n value in JWK</param>
        /// <param name="p">some p value in JWK</param>
        /// <param name="q">some q value in JWK</param>
        /// <param name="qi">some qi value in JWK</param>
        /// <param name="x">X coordinate shown in base64url-encoded
        /// values</param>
        ...
        /// certificate.</param>
        /// <param name="y">Y coordinate shown in base64url-encoded
        /// values</param>
        ...
        /// <summary>
        /// Gets or sets some d value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "d")]
        public string D { get; set; }

        /// <summary>
        /// Gets or sets some dp value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "dp")]
        public string Dp { get; set; }

        /// <summary>
        /// Gets or sets some dq value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "dq")]
        public string Dq { get; set; }

        /// <summary>
        /// Gets or sets some e value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "e")]
        public string E { get; set; }

        /// <summary>
        /// Gets or sets some k value in JWK
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets some n value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "n")]
        public string N { get; set; }

        /// <summary>
        /// Gets or sets some p value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "p")]
        public string P { get; set; }

        /// <summary>
        /// Gets or sets some q value in JWK
        /// </summary>
        [JsonProperty(PropertyName = "q")]
        public string Q { get; set; }

        /// <summary>
        /// Gets or sets some qi value in JWK
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets x coordinate shown in base64url-encoded values
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets y coordinate shown in base64url-encoded values
        /// </summary>
