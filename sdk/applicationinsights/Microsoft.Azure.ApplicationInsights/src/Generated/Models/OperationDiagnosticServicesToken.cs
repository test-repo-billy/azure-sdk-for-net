...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    /// </summary>
    public partial class OperationDiagnosticServicesToken
    {
        /// <summary>
        /// Initializes a new instance of the OperationDiagnosticServicesToken
        /// class.
        /// </summary>
        public OperationDiagnosticServicesToken()
        {
            CustomInit();
        }
        ...
        public OperationDiagnosticServicesToken(string name = default(string), OperationInfo display = default(OperationInfo), string origin = default(string), object properties = default(object))
        {
            Name = name;
            Display = display;
            Origin = origin;
