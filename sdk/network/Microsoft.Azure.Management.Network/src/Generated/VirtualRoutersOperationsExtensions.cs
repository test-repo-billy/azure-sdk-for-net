...
namespace Microsoft.Azure.Management.Network
{
    ...
    public static partial class VirtualRoutersOperationsExtensions
    {
            ...
            /// </param>
            public static VirtualRouter UpdateTags(this IVirtualRoutersOperations operations, string resourceGroupName, string virtualRouterName, TagsObject parameters)
            {
                return operations.UpdateTagsAsync(resourceGroupName, virtualRouterName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<VirtualRouter> UpdateTagsAsync(this IVirtualRoutersOperations operations, string resourceGroupName, string virtualRouterName, TagsObject parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateTagsWithHttpMessagesAsync(resourceGroupName, virtualRouterName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
