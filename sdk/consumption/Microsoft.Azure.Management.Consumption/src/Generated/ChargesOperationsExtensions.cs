...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public static partial class ChargesOperationsExtensions
    {
            ...
            /// </param>
            public static ChargesListResult ListByScope(this IChargesOperations operations, string scope, string startDate = default(string), string endDate = default(string), string filter = default(string), string apply = default(string))
            {
                return operations.ListByScopeAsync(scope, startDate, endDate, filter, apply).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<ChargesListResult> ListByScopeAsync(this IChargesOperations operations, string scope, string startDate = default(string), string endDate = default(string), string filter = default(string), string apply = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListByScopeWithHttpMessagesAsync(scope, startDate, endDate, filter, apply, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
